...
SRCS=qihse_core.c qihse_search.c qihse_math.c qihse_instr.c qihse_hetero.c qihse_vector_db.c qihse_exports.c \
     algorithms/qihse_dimensions.c algorithms/qihse_verification.c \

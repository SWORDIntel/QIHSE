...
- [ ] **`FABRIC.SUBMIT` does not dispatch remotely.** A job whose best-fit node is another node is recorded `queued` and never runs. Needs a transport and a result path.

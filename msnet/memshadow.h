...
/* Protocol Constants */
#define MEMSHADOW_MAGIC 0x4D53485700000000ULL  // "QHSG" padded to 8 bytes
...
typedef enum {
    ...
    /* QHIO Intelligence Operations (0xD0xx) */
    MSG_QHIO_INTELLIGENCE_COLLECTION = 0xD001,
    MSG_QHIO_INTELLIGENCE_PROCESSING = 0xD002,
    MSG_QHIO_INTELLIGENCE_DISSEMINATION = 0xD003,
    MSG_QHIO_INTELLIGENCE_ARCHIVAL = 0xD004,
    MSG_QHIO_INTELLIGENCE_QUERY = 0xD005,
    MSG_QHIO_INTELLIGENCE_REPORTING = 0xD006,
    MSG_QHIO_INTELLIGENCE_CORRELATION = 0xD007,
    MSG_QHIO_INTELLIGENCE_SYNTHESIS = 0xD008,

    /* AI Processing Operations (0xD3xx) */
    MSG_QHIO_AI_MODEL_DEPLOYMENT = 0xD301,
    MSG_QHIO_AI_INFERENCE_REQUEST = 0xD302,
    MSG_QHIO_AI_TRAINING_COORDINATION = 0xD303,
    MSG_QHIO_AI_MODEL_SYNCHRONIZATION = 0xD304,
    MSG_QHIO_AI_QUANTUM_PROCESSING = 0xD305,
    MSG_QHIO_AI_NEUROMORPHIC_EXECUTION = 0xD306,
    MSG_QHIO_AI_EXPLAINABILITY = 0xD307,
    MSG_QHIO_AI_ADVERSARIAL_TESTING = 0xD308,

    /* Advanced Routing Operations (0xD4xx) */
    MSG_QHIO_MOE_ROUTING = 0xD401,
    MSG_QHIO_TOPOLOGY_AWARE_ROUTING = 0xD402,
    MSG_QHIO_LOAD_BALANCING = 0xD403,
    MSG_QHIO_PRIORITY_BASED_ROUTING = 0xD404,
    MSG_QHIO_RESILIENCE_ROUTING = 0xD405,
    MSG_QHIO_COVERT_ROUTING = 0xD406,
    MSG_QHIO_MULTICAST_INTELLIGENCE = 0xD407,
    MSG_QHIO_BROADCAST_ALERT = 0xD408,

    /* Security and Cryptographic Operations (0xD5xx) */
    MSG_QHIO_PQC_KEY_EXCHANGE = 0xD501,
    MSG_QHIO_STEGANOGRAPHY_ENCODING = 0xD502,
    MSG_QHIO_COVERT_CHANNEL_ESTABLISHMENT = 0xD503,
    MSG_QHIO_TAMPER_DETECTION = 0xD504,
    MSG_QHIO_ZERO_KNOWLEDGE_PROOF = 0xD505,
    MSG_QHIO_QUANTUM_KEY_DISTRIBUTION = 0xD506,
    MSG_QHIO_HOMOMORPHIC_ENCRYPTION = 0xD507,
    MSG_QHIO_SECURE_MULTIPARTY_COMPUTATION = 0xD508,

    /* Orchestration and Coordination (0xD6xx) */
    MSG_QHIO_SPOE_INTELLIGENCE_ORCHESTRATION = 0xD601,
    MSG_QHIO_WORKFLOW_EXECUTION = 0xD602,
    MSG_QHIO_RESOURCE_ALLOCATION = 0xD603,
    MSG_QHIO_PERFORMANCE_MONITORING = 0xD604,
    MSG_QHIO_FAILURE_RECOVERY = 0xD605,
    MSG_QHIO_LOAD_SHEDDING = 0xD606,
    MSG_QHIO_MAINTENANCE_COORDINATION = 0xD607,
    MSG_QHIO_AUDIT_LOG_SYNCHRONIZATION = 0xD608,

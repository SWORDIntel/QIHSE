...
QIHSE degrades gracefully under load, falls back natively when AVX-512/AVX2 instructions aren't available, and actively guards the host system against hostile workloads. **It works flawlessly on any system.**

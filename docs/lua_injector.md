...
## Official TRITON Plugins

Instead of writing scripts from scratch, analysts can utilize the pre-compiled, tactical plugins located in the `plugins/lua/` directory. These scripts demonstrate complex real-world operations ranging from Signals Intelligence to Aerospace mathematics.

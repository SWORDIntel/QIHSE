...
### [🔒 Security](security/)
CNSA 2.0 alignment (in progress), cryptographic operations, access control, audit logging, and threat mitigation. Transport encryption (ChaCha20-Poly1305 AEAD) is implemented and opt-in via ctx->tls_ctx; cleartext is the default.

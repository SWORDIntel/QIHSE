...
> **Security Audit**: Multi-pass audit completed. All unsafe functions eliminated, file I/O hardened with `O_NOFOLLOW`, PRNG upgraded to `RAND_bytes`, symlink/TOCTOU/CWD injection mitigated, partial writes and SIGPIPE handled. See [hardening report](docs/security/hardening-report.md) for full details.
